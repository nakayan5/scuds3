...
const ClosableDrawer = (props) => {
    ...
    const {container} = props;   // propsをcontainerという連想配列にする
    ...
    const menus = [
        ...
        {func: selectMenu, label: 'マイページ', icon: <PersonIcon />, id: 'mypage', value: '/mypage' }
    ]
    ...
    return (
        <nav className={classes.drawer}> 
            <Drawer
                ...
                ModalProps={{keepMounted: true}}  // スマホ時のパフォーマンス
            >
                <div
                    onClose={(e) => props.onClose(e)}
                ...
                >
                    {/* <div className={classes.searchField}>
                        <TextInput 
                            ...
                            onChange={inputKeyword} required={false} 
                    ...
                    {/* <List>
                        {filters.map((filter) => (
                            <ListItem
                                button key={filter.id} onClick={(e) => filter.func(e, filter.value)}
                            >
